<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 17:14:11
         compiled from "areas\admin\views\profile\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4947522e26ef518264-28565388%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a2894da04f972c71077cb7d630645fb456ad272' => 
    array (
      0 => 'areas\\admin\\views\\profile\\index.tpl',
      1 => 1378757625,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '4947522e26ef518264-28565388',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_522e26ef7920b4_40331710',
  'variables' => 
  array (
    'Url' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_522e26ef7920b4_40331710')) {function content_522e26ef7920b4_40331710($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" alt="" width="195" height="200" /></p>
        ...
        <div id="content">
            <div class="contentTop">
                <span class="pageTitle"><span class="icon-home"></span>teste</span>
                <ul class="quickStats">
                    <li>
                ...
                <div class="widget">
                    ...
                    <div class="formRow">
                        <div class="grid3">
                            ...
                            :</div>
                        <div class="grid4"><input type="text" class="validate[required]" name="req" id="req"/><span class="note">Seu Primeiro Nome.</span></div>
                        <div class="grid4"><input type="text" class="validate[required]" name="req" id="req"/><span class="note">Seu Segundo Nome ou Sobrenome.</span></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Sua Senha:<span class="req">*</span></label></div>
                        <div class="grid4"><input type="password" class="validate[required]" name="password1" id="password1" /><span class="note">Cadastre um senha</span></div>
                        <div class="grid4"><input type="password" class="validate[required,equals[password]]" name="password2" id="password2" /><span class="note">Confime a senha cadastrada.</span></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3">
                            <label>E-mail de Cadastro:<span class="req">*</span></label></div>
                        <div class="grid4"><input type="text" value="" class="validate[required,custom[email]]" name="emailValid" id="emailValid"/><span class="note">Informe seu e-mail para cadastro.</span></div>                          <div class="grid4"><input type="text" value="" class="validate[required,custom[email]]" name="emailValid" id="emailValid"/><span class="note">Confirme seu e-mail de cadastro.</span></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Data de nascimento:</label></div>
                        <div class="grid4"><input type="text" class="maskDate" id="maskDate" value="value" /><span class="note">99/99/9999</span></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
